...
class QTransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.self_attn_layer_norm = QLayerNorm(self.embed_dim)
...
class QTransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(
        ...
        # self.self_attn_layer_norm = QLayerNorm(self.embed_dim, export=export)
        self.self_attn_layer_norm = QLayerNorm(self.embed_dim)
        ...
        if no_encoder_attn:
            ...
            # self.encoder_attn_layer_norm = QLayerNorm(self.embed_dim, export=export)
            self.encoder_attn_layer_norm = QLayerNorm(self.embed_dim)
        ...
        # self.final_layer_norm = QLayerNorm(self.embed_dim, export=export)
        self.final_layer_norm = QLayerNorm(self.embed_dim)
        self.need_attn = True
...
# replace fully connect with our implememted linear layers
