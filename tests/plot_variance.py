...
style = ['r', 'y', 'b', 'r:', 'y:', 'b:']
for model, s in zip(['quantize', 'quantize_persample', 'quantize_persample_perlayer',
              'qlinear', 'qlinear_persample', 'qlinear_persample_perlayer'], style):
    file_name = '../resnet/resnet50_{}.txt'.format(model)
    grad_norm = []
    sample_var = []
    bias = []
    var = []
