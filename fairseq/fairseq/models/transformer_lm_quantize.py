...
from fairseq.models.transformer_quantize import (
    Embedding,
    TransformerDecoder
)
...
@register_model('qtransformer_lm')
class QTransformerLanguageModel(FairseqLanguageModel):
...
@register_model_architecture('qtransformer_lm', 'qtransformer_lm')
